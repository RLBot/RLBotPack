...
class car_object:
    ...
    def update(self, packet):
        ...
        self.angles = Vector3(car.physics.rotation.pitch, car.physics.rotation.yaw, car.physics.rotation.roll)
...
class Vector3:
    ...
    def v_angle(self,value):
        #Returns the angle between this Vector3 and another Vector3
        return math.acos(self.dot(value) / self.magnitude() * value.magnitude())
