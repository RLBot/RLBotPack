...
class MyBot(BaseAgent):
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        def shot_variables_defense(target):
            ...
            target_t = [max_t, max_t, max_t, 0]
            target_f = [ball_states[round(max_t * 60)], ball_states[round(max_t * 60)], ball_states[round(max_t * 60)], ball_states[0]]
            ...
            for i in range(round(max_t * 60) + 1):
                ...
                if target_t[0] == max_t and hit_d_check(bpos, t): # Hits
                    if bpos.z - offset_vec.z * 134.85 > max_jump_height[0]:
                        ...
                        target_t[0] = t
                        target_f[0] = bp
                if target_t[1] == max_t and hit_double_check(bpos, t): # Double Jumps
        ...
        def general_strategy_2():
            ...
            if closest_to_ball[0] == self.index:
                shoot_ball(tf, li, other_cars, double_jump = li[0][2] < li[0][1], aerial = True)
