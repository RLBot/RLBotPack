...
class MyBot(BaseAgent):
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        def shoot_ball(target, li, other_cars, flick = False, double_jump = False, aerial = False):
        ...
        def general_strategy():
            ...
            if closest_to_ball[0] == self.index:
                ...
                if go_up_wall == True:
                    ...
                    shoot_ball(tf, li, other_cars, double_jump = to_double_jump, aerial = True) # target_t, target_f, wait_for_fall
                    txt = "Shoot"
                    if to_double_jump:
                        txt += ", Double"
                    self.renderer.draw_string_3d(car_location, 1, 1, txt, self.renderer.green())
