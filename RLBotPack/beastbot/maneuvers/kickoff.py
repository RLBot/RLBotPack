...
class SecondManSlowCornerKickoffManeuver(Maneuver):
    ...
    def exec(self, bot) -> SimpleControllerState:
        ...
        return bot.drive.go_towards_point(bot, curve_point, target_vel=1200, slide=True, boost_min=20,
...
class CollectSpecificBoostManeuver(Maneuver):
    ...
    def exec(self, bot) -> SimpleControllerState:
        ...
        return bot.drive.go_towards_point(bot, self.boost_pad_pos, target_vel=2300, boost_min=0, can_keep_speed=True)
