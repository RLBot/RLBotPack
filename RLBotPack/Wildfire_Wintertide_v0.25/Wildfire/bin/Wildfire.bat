...
set DEFAULT_JVM_OPTS="-Djna.library.path=build/dll" "-Duser.dir=%~dp0."
...
set CLASSPATH=%APP_HOME%\lib\Wildfire.jar;%APP_HOME%\lib\dll;%APP_HOME%\lib\framework-1.3.2.jar;%APP_HOME%\lib\jna-platform-4.5.1.jar;%APP_HOME%\lib\jna-4.5.1.jar;%APP_HOME%\lib\py4j-0.10.6.jar;%APP_HOME%\lib\flatbuffers-java-1.9.0.1.jar
