...
public class BinarySearcher2 {
    ...
    private double leftSample;
    private double middleSample;
    private double rightSample;
    ...
    public BinarySearcher2(GenericData dataHandler) {
        this.parameterToOptimize = dataHandler;
        this.bestParameter = dataHandler.copy();
        this.bestHypothesis = DEFAULT_SEARCH_RANGE;
        this.leftSample = -DEFAULT_SEARCH_RANGE;
        this.middleSample = 0;
        this.rightSample = DEFAULT_SEARCH_RANGE;
