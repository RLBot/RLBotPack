...
from kerny_obs import kernyObsBuilder, BOOST_LOCATIONS
...
class kerny(BaseAgent):
    def __init__(self, name, team, index,
        ...
        print('kerny Ready - Index:', index)
        print("Remember to run kerny at 120fps with vsync off! "
    ...
    def initialize_agent(self):
        ...
        self.obs_builder = kernyObsBuilder(field_info=self.field_info)
